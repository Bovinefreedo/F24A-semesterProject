...
JSC.fetch( 
  './resources/US-population-by-state-1900-2019.csv'
) 
    ...
    { 
      ...
      title: { 
        label: { 
          ...
          text: 
            'US Population by State: <b>1900</b> year'
        } 
      }, 
      legend: { 
        template: '%icon %name', 
      ...
      defaultPoint: { 
        tooltip: 
          '%year<br>%xValue: <b>%yValue</b>', 
        label: { 
          text: 
            ' <b>%id</b> {(Math.round(%yValue/1000)*1000):a}', 
          autoHide: true
        } 
      }, 
